...
const trendOption = computed(() => {
  ...
  return {
    ...
    legend: {
      data: [
        t("analyticsFinance.deposit"),
        t("analyticsFinance.withdrawal"),
        t("analyticsFinance.netProfit"),
      ],
      bottom: 0,
    },
    ...
    series: [
      {
        name: t("analyticsFinance.deposit"),
        type: "line",
        smooth: true,
        data: td.map((d) => d.deposit),
        itemStyle: { color: COLORS.green },
        areaStyle: { color: "rgba(0,150,136,0.08)" },
      },
      {
        name: t("analyticsFinance.withdrawal"),
        type: "line",
        smooth: true,
        data: td.map((d) => d.withdrawal),
        itemStyle: { color: COLORS.red },
        areaStyle: { color: "rgba(255,87,34,0.08)" },
      },
      {
        name: t("analyticsFinance.netProfit"),
        type: "bar",
        data: td.map((d) => d.net),
        itemStyle: { color: (p: any) => (p.value >= 0 ? COLORS.green : COLORS.red) },
      },
    ],
  };
});
...
const feeOption = computed(() => {
  ...
  return {
    ...
    legend: {
      data: [
        t("analyticsFinance.transactionFee"),
        t("analyticsFinance.commission"),
        t("analyticsFinance.promotionLabel"),
        t("analyticsFinance.thirdPartyRebate"),
      ],
      bottom: 0,
    },
    grid: { top: 10, right: 20, bottom: 55, left: 60, containLabel: false },
    ...
    series: [
      {
        name: t("analyticsFinance.transactionFee"),
        type: "line",
        smooth: true,
        data: fd.map((d) => d.chargeFee),
        itemStyle: { color: COLORS.blue },
      },
      {
        name: t("analyticsFinance.commission"),
        type: "line",
        smooth: true,
        data: fd.map((d) => d.commission),
        itemStyle: { color: COLORS.yellow },
      },
      {
        name: t("analyticsFinance.promotionLabel"),
        type: "line",
        smooth: true,
        data: fd.map((d) => d.promotion),
        itemStyle: { color: COLORS.purple },
      },
      {
        name: t("analyticsFinance.thirdPartyRebate"),
        type: "line",
        smooth: true,
        data: fd.map((d) => d.thirdRebate),
    ...
    series: [
      {
        ...
        data: data.value.depositStatusBreakdown.map((d, i) => ({
          name: d.status,
          value: d.amount,
    ...
    series: [
      {
        ...
        label: { show: false },
        emphasis: { label: { show: true, fontSize: 12 } },
        data: data.value.withdrawalStatusBreakdown.map((d, i) => ({
          name: d.status,
          value: d.amount,
          itemStyle: { color: PALETTE[i % PALETTE.length] },
        })),
    ...
    <template v-else-if="data">
      ...
      <lay-row :space="15">
        <lay-col :md="12">
          <lay-card class="section-card">
            <div class="section-header">
              {{ t("analyticsFinance.depositByAgent") }}
            </div>
        ...
        <lay-col :md="12">
          <lay-card class="section-card">
            <div class="section-header">
              {{ t("analyticsFinance.withdrawByAgent") }}
            </div>
      ...
      <lay-card class="section-card">
        <div class="section-header">
          {{ t("analyticsFinance.feesCommissions") }}
        </div>
      ...
      <lay-row :space="15">
        <lay-col :md="12">
          <lay-card class="section-card">
            <div class="section-header">
              {{ t("analyticsFinance.depositStatus") }}
            </div>
        ...
        <lay-col :md="12">
          <lay-card class="section-card">
            <div class="section-header">
              {{ t("analyticsFinance.withdrawStatus") }}
            </div>
      ...
      <lay-row :space="15">
        <lay-col :md="12">
          <lay-card class="section-card">
            <div class="section-header">
              {{ t("analyticsFinance.topDeposit") }}
            </div>
            <table class="data-table">
              <thead>
                <tr>
                  <th>{{ t("analyticsFinance.rank") }}</th>
                  <th>Username</th>
                  <th>{{ t("analyticsFinance.agent") }}</th>
                  <th style="text-align: right">
                    {{ t("analyticsFinance.totalDeposit") }}
                  </th>
                  <th style="text-align: right">
                    {{ t("analyticsFinance.orderCount") }}
                  </th>
                </tr>
              </thead>
              <tbody>
        ...
        <lay-col :md="12">
          <lay-card class="section-card">
            <div class="section-header">
              {{ t("analyticsFinance.topWithdraw") }}
            </div>
            <table class="data-table">
              <thead>
                <tr>
                  ...
                  <th>{{ t("analyticsFinance.agent") }}</th>
                  <th style="text-align: right">
                    {{ t("analyticsFinance.totalWithdraw") }}
                  </th>
                  <th style="text-align: right">
                    {{ t("analyticsFinance.orderCount") }}
                  </th>
